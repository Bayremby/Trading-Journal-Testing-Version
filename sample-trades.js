// Sample trades for testing AI Mentor feature
const sampleTrades = [
  {
    id: 'trade-001',
    systemId: 'system-001',
  ...
  },
  {
    ...
    reflection: {
      ...
      mistakes: 'Ignared rule 001',
      whatWentWell: 'Quick exit',
      lesson: 'Don't trade when tired'
    }
  },
  {
    id: 'trade-005',
...
if (typeof window !== 'undefined') {
  window.sampleTrades = sampleTrades;
  window.sampleSystem = sampleSystem;
  
  console.log('Sample data loaded!');
  console.log('To add trades, run: window.addSampleTrades()');
  console.log('To add system, run: window.addSampleSystem()');
  
  window.addSampleTrades = () => {
    ...
    console.log(`Added ${sampleTrades.length} sample trades. Total: ${updatedTrades.length}`);
    location.reload();
  };
  
  window.addSampleSystem = () => {
    ...
    console.log('Added sample system');
    location.reload();
  };
}
